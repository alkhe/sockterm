(function e$$0(g,a,l){function d(e,n){if(!a[e]){if(!g[e]){var k="function"==typeof require&&require;if(!n&&k)return k(e,!0);if(f)return f(e,!0);k=Error("Cannot find module '"+e+"'");throw k.code="MODULE_NOT_FOUND",k;}k=a[e]={exports:{}};g[e][0].call(k.exports,function(a){var f=g[e][1][a];return d(f?f:a)},k,k.exports,e$$0,g,a,l)}return a[e].exports}for(var f="function"==typeof require&&require,e=0;e<l.length;e++)d(l[e]);return d})({1:[function(h,g,a){(function(){var a,d,f,e,q,n,k,p,s=[].slice;e=h("entities");
d={ef0:"color:#000",ef1:"color:#A00",ef2:"color:#0A0",ef3:"color:#A50",ef4:"color:#00A",ef5:"color:#A0A",ef6:"color:#0AA",ef7:"color:#AAA",ef8:"color:#555",ef9:"color:#F55",ef10:"color:#5F5",ef11:"color:#FF5",ef12:"color:#55F",ef13:"color:#F5F",ef14:"color:#5FF",ef15:"color:#FFF",eb0:"background-color:#000",eb1:"background-color:#A00",eb2:"background-color:#0A0",eb3:"background-color:#A50",eb4:"background-color:#00A",eb5:"background-color:#A0A",eb6:"background-color:#0AA",eb7:"background-color:#AAA",
eb8:"background-color:#555",eb9:"background-color:#F55",eb10:"background-color:#5F5",eb11:"background-color:#FF5",eb12:"background-color:#55F",eb13:"background-color:#F5F",eb14:"background-color:#5FF",eb15:"background-color:#FFF"};n=function(b){for(b=b.toString(16);2>b.length;)b="0"+b;return b};[0,1,2,3,4,5].forEach(function(b){return[0,1,2,3,4,5].forEach(function(c){return[0,1,2,3,4,5].forEach(function(m){var a;a=16+36*b+6*c+m;var t,r,e,f;e=[0<b?40*b+55:0,0<c?40*c+55:0,0<m?40*m+55:0];f=[];t=0;for(r=
e.length;t<r;t++)m=e[t],f.push(n(m));m=f.join("");d["ef"+a]="color:#"+m;return d["eb"+a]="background-color:#"+m})})});(function(){p=[];for(k=0;23>=k;k++)p.push(k);return p}).apply(this).forEach(function(b){var c;c=b+232;b=n(10*b+8);d["ef"+c]="color:#"+b+b+b;return d["eb"+c]="background-color:#"+b+b+b});q=function(){var b,c,m,a,d,r,e;b=arguments[0];a=2<=arguments.length?s.call(arguments,1):[];r=0;for(e=a.length;r<e;r++)for(c in m=a[r],m)d=m[c],b[c]=d;return b};f={fg:"#FFF",bg:"#000",escapeXML:!1};
a=function(){function b(c){null==c&&(c={});this.opts=q({},f,c);this.input=[];this.stack=[]}b.prototype.toHtml=function(c){var b;this.input="string"===typeof c?[c]:c;b=[];this.forEach(function(c){return b.push(c)});this.input=[];return b.join("")};b.prototype.forEach=function(c){var b,a;b="";a=function(b){return function(a){a=parseInt(a,10);-1===a&&c("<br/>");0===a&&b.stack.length&&c(b.resetStyles());1===a&&c(b.pushTag("b"));2<a&&5>a&&c(b.pushTag("u"));4<a&&7>a&&c(b.pushTag("blink"));8===a&&c(b.pushStyle("display:none"));
9===a&&c(b.pushTag("strike"));24===a&&c(b.closeTag("u"));29<a&&38>a&&c(b.pushStyle("ef"+(a-30)));39===a&&c(b.pushStyle("color:"+b.opts.fg));39<a&&48>a&&c(b.pushStyle("eb"+(a-40)));49===a&&c(b.pushStyle("background-color:"+b.opts.bg));89<a&&98>a&&c(b.pushStyle("ef"+(8+(a-90))));if(99<a&&108>a)return c(b.pushStyle("eb"+(8+(a-100))))}}(this);this.input.forEach(function(d){return function(e){b+=e;return d.tokenize(b,function(b,m){switch(b){case "text":return c(d.pushText(m));case "display":return a(m);
case "xterm256":return c(d.pushStyle("ef"+m))}})}}(this));if(this.stack.length)return c(this.resetStyles())};b.prototype.pushTag=function(b,a){null==a&&(a="");a.length&&-1===a.indexOf(":")&&(a=d[a]);this.stack.push(b);return["<"+b,a?' style="'+a+'"':void 0,">"].join("")};b.prototype.pushText=function(b){return this.opts.escapeXML?e.encodeXML(b):b};b.prototype.pushStyle=function(b){return this.pushTag("span",b)};b.prototype.closeTag=function(b){var a;this.stack.slice(-1)[0]===b&&(a=this.stack.pop());
if(null!=a)return"</"+b+">"};b.prototype.resetStyles=function(){var b,a;a=[this.stack,[]];b=a[0];this.stack=a[1];return b.reverse().map(function(b){return"</"+b+">"}).join("")};b.prototype.tokenize=function(b,a){var d,e,f,g,h,k,l,s,p;d=!1;f=function(b){return""};e=function(b){return function(c){b.opts.newline?a("display",-1):a("text",c);return""}}(this);k=[{pattern:/^\x08+/,sub:f},{pattern:/^\x1b\[38;5;(\d+)m/,sub:function(b,c){a("xterm256",c);return""}},{pattern:/^\n+/,sub:e},{pattern:/^\x1b\[((?:\d{1,3};?)+|)m/,
sub:function(b,c){var e,f,g;d=!0;0===c.trim().length&&(c="0");c=c.trimRight(";").split(";");f=0;for(g=c.length;f<g;f++)e=c[f],a("display",e);return""}},{pattern:/^\x1b\[?[\d;]{0,3}/,sub:f},{pattern:/^([^\x1b\x08\n]+)/,sub:function(b){a("text",b);return""}}];h=function(a,e){3<e&&d||(d=!1,b.match(a.pattern),b=b.replace(a.pattern,a.sub))};for(p=[];0<(g=b.length);){f=l=0;for(s=k.length;l<s;f=++l)e=k[f],h(e,f);if(b.length===g)break;else p.push(void 0)}return p};return b}();g.exports=a}).call(this)},{entities:2}],
2:[function(h,g,a){var l=h("./lib/encode.js"),d=h("./lib/decode.js");a.decode=function(a,e){return(!e||0>=e?d.XML:d.HTML)(a)};a.decodeStrict=function(a,e){return(!e||0>=e?d.XML:d.HTMLStrict)(a)};a.encode=function(a,d){return(!d||0>=d?l.XML:l.HTML)(a)};a.encodeXML=l.XML;a.encodeHTML4=a.encodeHTML5=a.encodeHTML=l.HTML;a.decodeXML=a.decodeXMLStrict=d.XML;a.decodeHTML4=a.decodeHTML5=a.decodeHTML=d.HTML;a.decodeHTML4Strict=a.decodeHTML5Strict=a.decodeHTMLStrict=d.HTMLStrict;a.escape=l.escape},{"./lib/decode.js":3,
"./lib/encode.js":5}],3:[function(h,g,a){function l(a){var d=Object.keys(a).join("|"),b=f(a),c=new RegExp("&(?:"+(d+"|#[xX][\\da-fA-F]+|#\\d+")+");","g");return function(a){return String(a).replace(c,b)}}function d(a,d){return a<d?1:-1}function f(a){return function(d){return"#"===d.charAt(1)?"X"===d.charAt(2)||"x"===d.charAt(2)?n(parseInt(d.substr(3),16)):n(parseInt(d.substr(2),10)):a[d.slice(1,-1)]}}var e=h("../maps/entities.json"),q=h("../maps/legacy.json");a=h("../maps/xml.json");var n=h("./decode_codepoint.js");
h=l(a);a=l(e);var k=function(){function a(b){";"!==b.substr(-1)&&(b+=";");return l(b)}for(var g=Object.keys(q).sort(d),b=Object.keys(e).sort(d),c=0,h=0;c<b.length;c++)g[h]===b[c]?(b[c]+=";?",h++):b[c]+=";";var k=new RegExp("&(?:"+b.join("|")+"|#[xX][\\da-fA-F]+;?|#\\d+;?)","g"),l=f(e);return function(b){return String(b).replace(k,a)}}();g.exports={XML:h,HTML:k,HTMLStrict:a}},{"../maps/entities.json":7,"../maps/legacy.json":8,"../maps/xml.json":9,"./decode_codepoint.js":4}],4:[function(h,g,a){var l=
h("../maps/decode.json");g.exports=function(a){if(55296<=a&&57343>=a||1114111<a)return"\ufffd";a in l&&(a=l[a]);var f="";65535<a&&(a-=65536,f+=String.fromCharCode(a>>>10&1023|55296),a=56320|a&1023);return f+=String.fromCharCode(a)}},{"../maps/decode.json":6}],5:[function(h,g,a){function l(a){return Object.keys(a).sort().reduce(function(c,d){c[a[d]]="&"+d+";";return c},{})}function d(a){var c=[],d=[];Object.keys(a).forEach(function(a){1===a.length?c.push("\\"+a):d.push(a)});d.unshift("["+c.join("")+
"]");return new RegExp(d.join("|"),"g")}function f(a){return"&#x"+a.charCodeAt(0).toString(16).toUpperCase()+";"}function e(a){var c=a.charCodeAt(0);a=a.charCodeAt(1);return"&#x"+(1024*(c-55296)+a-56320+65536).toString(16).toUpperCase()+";"}function q(a,c){function d(c){return a[c]}return function(a){return a.replace(c,d).replace(p,e).replace(k,f)}}g=l(h("../maps/xml.json"));var n=d(g);a.XML=q(g,n);h=l(h("../maps/entities.json"));n=d(h);a.HTML=q(h,n);var k=/[^\0-\x7F]/g,p=/[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
s=d(g);a.escape=function(a){return a.replace(s,f).replace(p,e).replace(k,f)}},{"../maps/entities.json":7,"../maps/xml.json":9}],6:[function(h,g,a){g.exports={0:65533,128:8364,130:8218,131:402,132:8222,133:8230,134:8224,135:8225,136:710,137:8240,138:352,139:8249,140:338,142:381,145:8216,146:8217,147:8220,148:8221,149:8226,150:8211,151:8212,152:732,153:8482,154:353,155:8250,156:339,158:382,159:376}},{}],7:[function(h,g,a){g.exports={Aacute:"\u00c1",aacute:"\u00e1",Abreve:"\u0102",abreve:"\u0103",ac:"\u223e",
acd:"\u223f",acE:"\u223e\u0333",Acirc:"\u00c2",acirc:"\u00e2",acute:"\u00b4",Acy:"\u0410",acy:"\u0430",AElig:"\u00c6",aelig:"\u00e6",af:"\u2061",Afr:"\ud835\udd04",afr:"\ud835\udd1e",Agrave:"\u00c0",agrave:"\u00e0",alefsym:"\u2135",aleph:"\u2135",Alpha:"\u0391",alpha:"\u03b1",Amacr:"\u0100",amacr:"\u0101",amalg:"\u2a3f",amp:"&",AMP:"&",andand:"\u2a55",And:"\u2a53",and:"\u2227",andd:"\u2a5c",andslope:"\u2a58",andv:"\u2a5a",ang:"\u2220",ange:"\u29a4",angle:"\u2220",angmsdaa:"\u29a8",angmsdab:"\u29a9",
...
zscr:"\ud835\udccf",zwj:"\u200d",zwnj:"\u200c"}},{}],8:[function(h,g,a){g.exports={Aacute:"\u00c1",aacute:"\u00e1",Acirc:"\u00c2",acirc:"\u00e2",acute:"\u00b4",AElig:"\u00c6",aelig:"\u00e6",Agrave:"\u00c0",agrave:"\u00e0",amp:"&",AMP:"&",Aring:"\u00c5",aring:"\u00e5",Atilde:"\u00c3",atilde:"\u00e3",Auml:"\u00c4",auml:"\u00e4",brvbar:"\u00a6",Ccedil:"\u00c7",ccedil:"\u00e7",cedil:"\u00b8",cent:"\u00a2",copy:"\u00a9",COPY:"\u00a9",curren:"\u00a4",deg:"\u00b0",divide:"\u00f7",Eacute:"\u00c9",eacute:"\u00e9",
...
Uuml:"\u00dc",uuml:"\u00fc",Yacute:"\u00dd",yacute:"\u00fd",yen:"\u00a5",yuml:"\u00ff"}},{}],9:[function(h,g,a){g.exports={amp:"&",apos:"'",gt:">",lt:"<",quot:'"'}},{}],10:[function(h,g,a){window.ATH=h("ansi-to-html")},{"ansi-to-html":1}]},{},[10]);
